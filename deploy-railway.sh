#!/bin/bash
# Railway.app Quick Setup & Deploy Script
# Run this from your student-tracker repository root
...
if [ -f "Procfile" ] && [ -f "runtime.txt" ] && [ -f "requirements.txt" ] && [ -d ".streamlit" ]; then
